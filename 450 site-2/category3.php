...
<div class="w3-container" style="padding:64px 16px" id="product">
	<h3 class="w3-center">Towables</h3>
	<p class="w3-center w3-large">Click on any image for larger view</p>
			<?php

			// displays 4 products, 21 - 24
			$sql = "SELECT * FROM products LIMIT 4 OFFSET 20";
			...
			if ($result=mysqli_query($con,$sql))
			{
				...
				while ($row=mysqli_fetch_row($result))
				{
					...
					echo "<a href='tsunami.php' class='w3-button w3-block w3-theme w3-hover-teal'>View Details</a>";
					//echo $row[6];
					echo "</div>";
...
<div class="w3-row-padding w3-padding-64 w3-theme-l1" id="video">
	<div class="video-container">
		<iframe width="560" height="315" src="https://www.youtube.com/embed/vjafW-mcvU0?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
	</div>
</div>
