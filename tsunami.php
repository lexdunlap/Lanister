...
<div class="w3-top">
	<div class="w3-bar w3-black" id="myNavbar">
		<a href="index.html" class="w3-bar-item w3-button w3-teal"><i class="fa fa-home w3-margin-right"></i>AquaShop</a>
		<div class="w3-right w3-hide-small">
			...
			<div class="w3-dropdown-hover">
				...
				<div class="w3-dropdown-content w3-bar-block w3-black">
					<a href="category.html" class="w3-bar-item w3-button">Water Toys & Dive Gear</a>
					<a href="category2.html" class="w3-bar-item w3-button">Wakeskates & Wakesurfers</a>
					<a href="category3.html" class="w3-bar-item w3-button">Towables</a>
				</div>
			</div>
...
<div class="w3-container" style="padding:64px 16px" id="product">
	<h3 class="w3-center">Tsuanmi Wakesurfer</h3>
	<p class="w3-center w3-large">Click on image for larger view</p>
	<div class="w3-row-padding" style="margin-top:64px">
		<div class="w3-col l3 m4 w3-border w3-margin" style="padding:8px">
			<img src="images/tsunami.jpg" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="Tsunami Wakesurfer">
			<h3 class="w3-center">Tsunami Wakesurfer</h3>
			<p class="w3-center w3-large">$400.00</p>
			<a href="#" class="w3-button w3-block w3-theme w3-hover-teal">Add To Cart</a>
		</div>
		<div class="w3-margin">
			<?php
			...
			$sql="SELECT productName,description FROM products WHERE productID=17";
